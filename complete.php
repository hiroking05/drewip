<?php
    ...
    if (array_key_exists('target_company', $_POST)) {
        $company = $_POST['target_company'];
    }
    if (array_key_exists('target_mail', $_POST)) {
        $mail = $_POST['target_mail'];
    }
    if (array_key_exists('target_phone', $_POST)) {
        $phone = $_POST['target_phone'];
    }
    if (array_key_exists('target_contents', $_POST)) {
        $contents = $_POST['target_contents'];
    }
?>
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-sm navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="nav-bar">
                    <ul class="navbar-nav">
                        <li class="nav-item active"><a href="#" class="nav-link">会社情報</a></a></li>
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tr>
                    <th>氏名</th>
                    <td class=" mr-3 border-bottom"><?php print htmlspecialchars($name, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
                <tr>
                    <th>メール</th>
                ...
                <tr>
                    <th>電話番号</th>
                    <td><?php print htmlspecialchars($phone, ENT_QUOTES, "UTF-8"); ?></td>
                </tr>
                <tr>
                    <th>内容</th>
                    <td><?php print nl2br(htmlspecialchars ($contents, ENT_QUOTES, "UTF-8")); ?></td>
                </tr>
            </table>
